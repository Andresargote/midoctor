...
export default async function Welcome() {
	...
	return (
		<>
			<Confetti />
			<main className="container flex flex-col items-center justify-center h-screen px-6 mx-auto">
				<div className="flex flex-col gap-4 max-w-96">
					...
					<Link
						href="app/mi-perfil"
						className="p-4 mt-6 font-semibold text-center transition duration-300 rounded-full text-f-white bg-primary-500 hover:bg-primary-600"
					>
						Completar perfil
					</Link>
				</div>
